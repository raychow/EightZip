...
#define INTERFACE_IInArchive(x) \
    ...
    STDMETHOD(Extract)( \
        ...
        UINT32 numItems, \
        INT32 testMode, \
        IArchiveExtractCallback *extractCallback) x; \
...
#define INTERFACE_IArchiveUpdateCallback2(x) \
    ...
    STDMETHOD(GetVolumeStream)( \
        UINT32 index, \
        ISequentialOutStream **volumeStream) x; \
...
#define INTERFACE_IOutArchive(x) \
    STDMETHOD(UpdateItems)( \
        ISequentialOutStream *outStream, \
        UINT32 numItems, \
        IArchiveUpdateCallback *updateCallback) x; \
...
#define IMP_IInArchive_GetProp_WITH_NAME(k) \
    ...
    *propID = srcItem.propid; *varType = srcItem.vt; \
    if (srcItem.lpwstrName == 0) \
        ...
        *name = ::SysAllocString(srcItem.lpwstrName); return S_OK; }
...
#define IMP_IInArchive_Props_WITH_NAME \
    ...
    IMP_IInArchive_GetProp_WITH_NAME(kProps)


#define IMP_IInArchive_ArcProps \
    STDMETHODIMP CHandler::GetNumberOfArchiveProperties(UINT32 *numProperties) \
    { \
        *numProperties = sizeof(kArcProps) / sizeof(kArcProps[0]); \
        return S_OK; \
    } \
    STDMETHODIMP CHandler::GetArchivePropertyInfo \
    IMP_IInArchive_GetProp(kArcProps)
...
#define IMP_IInArchive_ArcProps_WITH_NAME \
    ...
    STDMETHODIMP CHandler::GetArchivePropertyInfo \
    IMP_IInArchive_GetProp_WITH_NAME(kArcProps)

#define IMP_IInArchive_ArcProps_NO_Table \
    STDMETHODIMP CHandler::GetNumberOfArchiveProperties(UINT32 *numProperties) \
    { *numProperties = 0; return S_OK; } \
    STDMETHODIMP CHandler::GetArchivePropertyInfo( \
        UINT32, BSTR *, PROPID *, VARTYPE *) \
    { return E_NOTIMPL; } 
