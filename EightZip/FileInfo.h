...
public:
    ...
    TString GetType() const { return GetType(m_tstrPath, IsDirectory(), false); }
    static TString GetType(TString tstrFileName, bool isDirectory = false, bool isVirtual = true);
    static int GetIconIndex(TString tstrFileName, bool isDirectory = false, bool isVirtual = true);
